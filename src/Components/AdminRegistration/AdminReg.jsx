...
const AdminReg = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If report field exists in formData, use it, otherwise set it to null
      if (!formData.report) {
        submissionData.report = null;
      }

      await set(newAdmissionRef, submissionData);
    ...
    <div className="admin-reg-container">
      ...
      <div className="admin-reg-content">
        ...
        <form onSubmit={handleSubmit} className="admin-reg-form">
          ...
          <div className="form-group">
            <label htmlFor="report">Student Previous Report Card (Optional, Max 2MB)</label>
            <input
              type="file"
              id="report"
              name="report"
