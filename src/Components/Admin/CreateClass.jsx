        ...
        <div className="create-class-container">
          ...
          {showForm && (
            <form className="create-class-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label htmlFor="admissionFee">Registration Fee (FCFA)</label>
                <input
                  type="number"
                  id="admissionFee"
                  name="admissionFee"
              ...
              <div className="form-group">
                <label htmlFor="sanitationHealthFee">Graduation Fee (FCFA)</label>
                <input
                  type="number"
              ...
              <div className="form-group">
                <label htmlFor="sportWearFee">Sport Wear + School T-Shirt (FCFA)</label>
                <input
                  type="number"
                  id="sportWearFee"
                  name="sportWearFee"
